...
public class drive extends OpMode {
    ...
    public void loop() {
        ...
        armDeflator = gamepad2.left_bumper && gamepad2.right_bumper ? 0.9 : gamepad2.left_bumper ? 0.4 : 0.7;
        {
            ...
            //tiny adjustments for arm
            //WARNING// DO NOT USE TOO MUCH OR PRESETS WILL GET MESSED UP
            //Actually though, try to use the least amount possible,
            // otherwise, a perfectly good match could be ruined for you and your team
            ...
            if (gamepad1.dpad_right) {
                r.frontLeft.setPower(-0.9);
                r.frontRight.setPower(-0.9);
                r.backLeft.setPower(-0.9);
                r.backRight.setPower(-0.9);
            }
        ...
        //grabber servo, "to grab or not to grab"
        ...
        //if (grab) {
        //    r.greenLED.setState(true);
        //    r.redLED.setState(false);
        //} else {
        //    r.greenLED.setState(false);
        //    r.redLED.setState(true);
        //}
