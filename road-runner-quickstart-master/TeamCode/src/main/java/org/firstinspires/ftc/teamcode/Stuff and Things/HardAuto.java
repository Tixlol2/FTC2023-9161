...
public class HardAuto extends hardware {
    ...
    public void goInches2(double inches, direction dir, double power) {
        ...
        while (backLeft.getCurrentPosition() != backLeft.getTargetPosition()) {
            for (DcMotor motor2 : Drive) {
                motor2.setPower(motor2.getCurrentPosition() / (motor2.getTargetPosition()/2));
            }
        }


        for (DcMotor motor1 : Drive) {
            motor1.setPower(0);
