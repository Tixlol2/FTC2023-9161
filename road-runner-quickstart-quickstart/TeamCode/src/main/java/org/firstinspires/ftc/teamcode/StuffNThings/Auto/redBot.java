...
@Autonomous(name = "redBot",  group = "Auto")

public class redBot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        TrajectorySequence traj1 = mecDrive.trajectorySequenceBuilder(r.redBot)
                //The random phase of the auton
                .lineToLinearHeading(r.redBotSpike)
                //Open + close left claw to drop on spike mark
                .addDisplacementMarker(() -> {
                    mecDrive.ClawFingerOne.setPosition(0);
                    sleep(250);
                    mecDrive.ClawFingerOne.setPosition(1);
                })
                //Move to backdrop
                ...
                .addDisplacementMarker(() -> {
                    ...
                    mecDrive.ClawWristTwo.setPower(-1);
                    sleep(400);
                    mecDrive.ClawWristOne.setPower(.1);
